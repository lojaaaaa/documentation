...
## Использование
  ...
  &emsp;🔴&emsp;Перед использованием команды `git commit --amend`, особенно если вы вносите изменения в историю коммитов, рекомендуется создать резервную копию вашего репозитория или ветки, чтобы в случае непредвиденных ситуаций можно было вернуться к предыдущему состоянию.
